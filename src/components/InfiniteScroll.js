        ...
        {posts.map((item) => (
          ...
          >
            <img
              src={
                item.poster_path
                  ? TMDB_IMG_Path + item.poster_path
                  : fallbackImg
              }
...
//               alt={`${item.original_title} Poster`}
//               className="w-full h-96 sm:h-60 object-contain sm:object-fill transform transition-transform duration-300 hover:scale-105 hover:cursor-pointer"
//               loading="lazy"
//             />
//             <div className="p-4">
//               <h2 className="text-2xl font-bold text-gray-800">
